...
public class VideoViewScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savedChanel = new SavedChanelManager(VideoViewScreen.this);
    ...
    private void initUI() {
        ...
        llYoutubeContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(VideoViewScreen.this, YoutubePlayerActivity.class);
    ...
    private void getLinkRTSP() {
        ...
        ApiVolley apiVolley = new ApiVolley(VideoViewScreen.this, new JSONObject(), "GET", ServerURL.getLink, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
    ...
    private void setListChanel(List<CustomItem> listItem, int saved){
        ...
        if(listItem != null && listItem.size() > 0){
            ...
            final ListChanelAdapter adapter = new ListChanelAdapter(VideoViewScreen.this, listItem);
    ...
    private void playVideo(String nama, String url){
        ...
        /*MediaController mediaController = new MediaController(VideoViewScreen.this);
        ...
        vvPlayVideo.setOnErrorListener(new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i, int i1) {
                ...
                Toast.makeText(VideoViewScreen.this, "Channel sudah tidak tersedia", Toast.LENGTH_LONG).show();
                return true;
            }
        });
    }
    ...
    public void onBackPressed() {
        if (doubleBackToExitPressedOnce) {
            ...
            Intent intent = new Intent(VideoViewScreen.this, VideoViewScreen.class);
